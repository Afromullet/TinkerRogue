...
TinkerRogue is a well-architected roguelike demonstrating pure ECS principles with performance-critical optimizations. The key architectural decisions—pure data components, EntityID-only relationships, query-based data access, and O(1) spatial queries—create a maintainable and extensible codebase.

**For Further Reading**:
- `docs/ecs_best_practices.md` - Detailed ECS patterns
- `CLAUDE.md` - Quick reference guide
- Reference implementations: `squads/`, `gear/Inventory.go`, `systems/positionsystem.go`

**For Questions/Contributions**:
- Study existing systems before adding new features
- Follow ECS patterns consistently
- Add tests for new components and systems
