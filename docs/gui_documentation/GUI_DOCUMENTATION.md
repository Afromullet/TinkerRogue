...
Comprehensive technical documentation for TinkerRogue's GUI system. This guide covers architectural patterns, mode catalog, implementation details, and best practices for building UI features.

> **Related Documentation:** See [DOCUMENTATION.md](../DOCUMENTATION.md) Section 9: "GUI Architecture" for cross-system integration patterns.
...
4. [Widget Creation Patterns](#widget-creation-patterns)
5. [Layout Patterns](#layout-patterns)
6. [Panel Building System](#panel-building-system)
7. [Component Architecture](#component-architecture)
8. [Mode Infrastructure](#mode-infrastructure)
9. [Input Handling](#input-handling)
10. [Service Integration](#service-integration)
11. [Command Pattern](#command-pattern)
12. [Query Abstraction](#query-abstraction)
13. [Rendering Patterns](#rendering-patterns)
14. [State Management](#state-management)
15. [Adding New Modes](#adding-new-modes)
16. [Best Practices](#best-practices)
17. [Mode Transitions](#mode-transitions)
18. [References](#references)
19. [Glossary](#glossary)
20. [Cross-Reference to Main Documentation](#cross-reference-to-main-documentation)
...
TinkerRogue's GUI system is built on a **mode-based architecture** that separates different UI contexts into distinct, self-contained modes.
...
**Hotkey:** `Ctrl+Tab` - Toggle between Overworld and Battle Map
...
**Access:** `ctx.ModeCoordinator.GetOverworldState()`
...
- `gui/guimodes/inventorymode.go` - Full-screen inventory mode
- `gui/guisquads/squaddeploymentmode.go` - Squad placement mode
- `gui/guimodes/infomode.go` - Tile/entity inspection mode

**Overworld Modes:**
- `gui/guisquads/squadmanagementmode.go` - Command pattern usage
- `gui/guisquads/squadbuilder.go` - Squad creation mode
- `gui/guisquads/formationeditormode.go` - Grid layout example
- `gui/guisquads/unitpurchasemode.go` - Unit purchasing mode
...
### Architecture & Design
| Topic | GUI_DOCUMENTATION.md | DOCUMENTATION.md |
|-------|----------------------|------------------|
...
| **Context Switching** | [Two-Context System](#two-context-system) | [GUI Architecture - Context](../DOCUMENTATION.md#mode-based-gui) |
...
**GUI_DOCUMENTATION.md** provides:
- **Complete mode catalog** with detailed descriptions of all 9 modes
- **Deep implementation details** for GUI patterns
- **Code examples** showing how to use each pattern
- **File structure** and organizational conventions
- **Best practices** and common pitfalls
- **Implementation checklist** for creating new GUI modes
