...
func printUsage() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  combat_tools balance                     Process all logs (default directory)")
	fmt.Println("  combat_tools balance --dir <path>         Override log directory")
	fmt.Println("  combat_tools balance --output <path>      Override output CSV path")
	fmt.Println("  combat_tools balance --help               Show this help message")
	fmt.Println()
