...
func printUsage() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  combat_tools compress                        Use defaults")
	fmt.Println("  combat_tools compress --input <path>         Custom input CSV")
	fmt.Println("  combat_tools compress --output <path>        Custom output CSV")
	fmt.Println("  combat_tools compress --help                 Show this help")
	fmt.Println()
