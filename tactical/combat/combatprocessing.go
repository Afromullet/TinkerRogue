...
func processAttackWithModifiers(attackerID ecs.EntityID, targetIDs []ecs.EntityID, result *CombatResult,
	...
	for _, defenderID := range targetIDs {
		...
		// Add targeting info
		defenderPos := common.GetComponentTypeByID[*squads.GridPositionData](manager, defenderID, squads.GridPositionComponent)
		...
		// Set target mode
		targetData := common.GetComponentTypeByID[*squads.TargetRowData](manager, attackerID, squads.TargetRowComponent)
		if targetData != nil {
