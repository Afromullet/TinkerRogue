...
func TestUnitRoster_GetUnitEntityForTemplate(t *testing.T) {
	...
	squadID := ecs.EntityID(999)
	unit1Entity.AddComponent(squadcore.SquadMemberComponent, &squadcore.SquadMemberData{SquadID: squadID})
	unit2Entity.AddComponent(squadcore.SquadMemberComponent, &squadcore.SquadMemberData{SquadID: squadID})
