// behaviors_per_battle.go — per-battle stateful perk behaviors.
//
// These behaviors read/write PerkBattleState. State persists across rounds
// until CleanupRoundState is called at combat end. See the package comment
// in behaviors_stateless.go for the taxonomy split.
package perks
